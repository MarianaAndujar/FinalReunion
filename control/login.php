...
*	@date   21/01/2015 
*
*	@brief  Ici se trouve le controleur de connéction
*
**/

// Pour pouvoir accéder à la bdd
include ("../model/MMembers.class.php");
	...
	else
	{
		...
		// Si on a bien des resultats, on complète les variables
		if($info != array())
		{
			$password2 = $info[0];
			$salt = $info[1];
		...
		{
			// On fait session_start() ici pour ne pas avoir a re-générer de 
			// jeton de session
			session_start();
